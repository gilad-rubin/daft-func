...
def _generate_node_label(
    ...
    Args:
        node: The node (string for input, NodeDef for function)
        node_type: Type of node ("input" or "function")
    ...
    *,
    ...
    if show_legend:
        ...
        if function_nodes:
            ...
            if input_nodes:
                legend_subgraph.edge("legend_input", "legend_function", style="invis")
